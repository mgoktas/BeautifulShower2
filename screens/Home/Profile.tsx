...
const Profile = ({route, navigation}) => {
    ...
    const [email, setEmail] = React.useState('mgoktashk@gmail.com')
    ...
    <SafeAreaView>
        <HeaderHome onPress={() => {navigation.navigate('Settings')}} title={'PROFILE'} type={3}/>
          ...
          <ScrollView>
            ...
            <ProfilePersonIt onPressProfile={() => {navigation.navigate('FullProfile')}} imageSource={avatarUrl} onPressAvatar={() => {
